		...
		<div class="container">
			<div class="row">
				<div class="col-md-4">
					<div class="blog-item">
						<a href="blog-single.html"><img
							src="resources/images/do si dos1q.jpg" alt=""></a>
						<div class="name">
							<h3
				...
				<div class="col-md-4">
					<div class="blog-item">
						<a href="blog-single.html"><img
							src="resources/images/samoas1.jpg" alt=""></a>
						<div class="name">
							<h3
								style="font-family: verdana; text-align: center; color: #FDFDFD">
								samoas</h3>
				...
				<div class="col-md-4">
					<div class="blog-item">
						<a href="blog-single.html"><img
							src="resources/images/tagalongs.jpg" alt=""></a>
						<div class="name">
							<h3
								style="font-family: verdana; text-align: center; color: #FDFDFD">
								tagalongs</h3>
					...
					<ul>
						...
						<li class="menu-item-has-children"><a href="#">Category</a>
							<ul class="sub-menu">
								...
								<li><a href="clients.html">Donuts</a></li>
